...
<div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow-md">
    ...
    <h1 class="text-2xl font-bold mb-6 text-gray-700 border-b pb-2">🐶 Novo Animal</h1>
    ...
    <form action="{{ route('animais.store') }}" method="POST">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="mb-4">
                ...
                <input type="text" id="especie" name="especie" placeholder="Ex: Cachorro, Gato" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>

            <div class="mb-4">
                <label for="raca" class="block text-gray-700 font-bold mb-2">Raça:</label>
                <input type="text" id="raca" name="raca" placeholder="Ex: Vira-lata, Poodle" class="w-full p-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
            </div>
        </div>
